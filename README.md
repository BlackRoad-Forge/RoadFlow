...
> Traffic flow visualization — 20x faster city-wide sim

Part of the [BlackRoad OS](https://blackroad.io) ecosystem. Forked from [`cityflow-project/CityFlow`](https://github.com/cityflow-project/CityFlow).
